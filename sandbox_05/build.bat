...
cl.exe /c /EHsc /I %ENGINE_DIR% /I %OPENGLDIR% /I %WINDOWDIR% /I %VENDOR_LIBS% /I %VENDOR_LIBS%\glew\include %SRC_DIR%\main.cpp %VENDOR_LIBS%\imgui\*.cpp  %OPENGLDIR%\*.cpp   %SRC_DIR%\Experience\World\objects\Triangle.cpp  %WINDOWDIR%\window.cpp   /Fo%OBJ_DIR%\
